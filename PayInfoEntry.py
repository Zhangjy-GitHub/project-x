...
if __name__ == '__main__':
    ...
    for r in range(1, data_sheet.max_row + 1):
        ...
        print(service_company + ' ' + str(pay_year) +
              '年度 支付金额: ' + str(actual_pay))
        pay_info = {'apply_pay': str(
            actual_pay), 'actual_pay': str(actual_pay)}
        generate_pay_info_form(company=service_company,
                               year=str(pay_year), pay_info=pay_info)
